...
# 3) Q. If I assign 100 tasks and the workers have reached the 80th task, with 80 tasks acknowledged, what happens when the Celery app crashes? Will the Celery worker automatically resume the pending tasks when I restart it?
